...
const styles = StyleSheet.create({
  ...
  categoryButton: { paddingVertical: 10, paddingHorizontal: 15, marginRight: 10, borderRadius: 20, backgroundColor: '#f0f0f0', borderWidth: 1, borderColor: '#ddd' },
  selectedCategoryButton: { backgroundColor: '#007AFF', borderColor: '#007AFF' },
